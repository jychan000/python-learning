CREATE TABLE `analyze_comment_incr` (
  ...
  `price_incr_1d` decimal(12,2) DEFAULT NULL COMMENT '价格差-1日',
  `price_incr_2d` decimal(12,2) DEFAULT NULL COMMENT '价格差-2日',
  `price_incr_3d` decimal(12,2) DEFAULT NULL COMMENT '价格差-3日',
  `price_incr_7d` decimal(12,2) DEFAULT NULL COMMENT '价格差-7日',
  `price_incr_10d` decimal(12,2) DEFAULT NULL COMMENT '价格差-10日',
  `price_incr_15d` decimal(12,2) DEFAULT NULL COMMENT '价格差-15日',
